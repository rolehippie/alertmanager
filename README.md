...
```YAML
alertmanager_arch: "{{ 'arm64' if ansible_facts['architecture'] == 'aarch64' or ansible_facts['architecture'] == 'arm64' else 'amd64' }}"
```
...
```YAML
alertmanager_oauth2_arch: "{{ 'arm64' if ansible_facts['architecture'] == 'aarch64' or ansible_facts['architecture'] == 'arm64' else 'amd64' }}"
```
...
```YAML
alertmanager_oauth2_version: 7.15.4
```
